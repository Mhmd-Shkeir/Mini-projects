...
<head>
    <meta charset="UTF-8">
    <title>Search Results - Movies</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <form class="d-flex ms-auto me-3" action="{{ route('movies.search') }}" method="GET">
                <input class="form-control me-2" type="search" placeholder="Search by title or description" name="q" value="{{ $query }}" required>
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-info" role="alert">
                    ...
                    <p>We couldn't find any movies matching "<strong>{{ $query }}</strong>". Try searching with different keywords.</p>
                    <hr>
                    <a href="{{ route('movies.listing') }}" class="btn btn-outline-primary">Back to All Movies</a>
                </div>
            </div>
        @endforelse
    </div>
